...
public:
  ...
  virtual TVector3                GetMWPCVector( const UInt_t n ) const;
  ...
  virtual UInt_t      GetTrueID( const UInt_t n ) const;
  virtual TLorentzVector GetTrueVector( const UInt_t n ) const;
